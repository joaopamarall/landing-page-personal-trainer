    ...
    >
      ...
      <div className="relative z-10 container-page py-20">
        <div className="max-w-xl lg:max-w-2xl text-center lg:text-left mx-auto lg:mx-0">
          ...
          <div className="mb-6 flex justify-center lg:justify-start hero-fade">
          ...
          {/* H1 principal */}
          <h1 className="font-display text-hero text-white uppercase mb-6 leading-none hero-up" style={{ animationDelay: '0.1s' }}>
            Chega de treino que não dá resultado.{' '}
            <span className="text-accent">Vou montar o seu.</span>
          </h1>

          {/* Tagline */}
          <p className="text-accent text-lg md:text-xl mb-4 font-sans font-medium hero-up" style={{ animationDelay: '0.2s' }}>
            Personal trainer em {PERSONAL.cidade} — treinos individualizados para quem quer resultado de verdade.
          </p>

          {/* Descricao */}
          <div className="text-white/80 text-base md:text-lg mb-8 space-y-2 font-sans hero-up" style={{ animationDelay: '0.3s' }}>
          ...
          {/* CTAs */}
          <div className="flex flex-col sm:flex-row flex-wrap justify-center lg:justify-start gap-4 mb-12 hero-up" style={{ animationDelay: '0.4s' }}>
            <Botao
              variante="primary"
              tamanho="lg"
          ...
          <div className="flex flex-wrap justify-center lg:justify-start gap-6 text-sm font-sans hero-up" style={{ animationDelay: '0.5s' }}>
